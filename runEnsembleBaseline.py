...
def main():
    ...
    param_grid = {'submodels__dtr__model__min_samples_split': [0.01, 0.05, 0.10, 0.25, 0.50],
                  'submodels__dtr__model__max_depth': [2,5,10,20,30, 50],
                  'submodels__dtr__model__min_samples_leaf': [0.01, 0.05, 0.10, 0.25, 0.50],
                  'submodels__dtr__model__max_features': [2,5,10,20,30,50],
                  'submodels__sgd__model__learning_rate': ['optimal'],
                  'submodels__sgd__model__max_iter': [10000],
                  'submodels__sgd__model__penalty': ['l2'],
