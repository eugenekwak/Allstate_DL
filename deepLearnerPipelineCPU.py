...
class deepLearner:
    ...
    def makePrediction(self, X_test, model_file, dr_pipeline_file):
        ...
        @ model_file: Fitted model from *.hdf5 file.
                      ex) 'models/deep_learning/weights.best.from_cpu_YYYY_MM_DD.hdf5'
        ...
        pred_df.to_csv('data/predictions/pred_cpu_dl_'+dt.datetime.now().strftime('%Y_%m_%d')+'.csv', index=False)
